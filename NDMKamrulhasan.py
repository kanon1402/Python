...
legend_element = [Patch(facecolor='#f9ff00', label='BSL'),
                  Patch(facecolor='#c085e9', label='COM'),
                  Patch(facecolor='#ff8600', label='JES'),
                  Patch(facecolor='#5d87a3', label='KHL'),
                  Patch(facecolor='#c1f588', label='MIR'),
                  Patch(facecolor='#e985d6', label='PAT')
                  ]
...
plt.title('Last 15 days avg stock : Mr. Kamrulahsan', fontsize=18, fontweight='bold', color='#3e0a75')
...
plt.tight_layout()
plt.savefig('T3(Kamrulahsan).png')
# plt.show()

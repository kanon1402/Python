...
#
#
colors = ['#f9ff00', '#c085e9', '#ff8600', '#5d87a3', '#c1f588', '#e985d6']
legend_element = [Patch(facecolor='#f9ff00', label='FEN'),
                  Patch(facecolor='#c085e9', label='MHK'),
                  Patch(facecolor='#ff8600', label='MLV'),
                  Patch(facecolor='#5d87a3', label='NOK'),
                  Patch(facecolor='#c1f588', label='SYL'),
                  Patch(facecolor='#e985d6', label='VRB')
                  ]
...
plt.title('Last 15 days avg stock : Mr. Amin', fontsize=18, fontweight='bold', color='#3e0a75')
plt.legend(handles=legend_element, loc='best', fontsize=11)
ax.axis('equal')

plt.tight_layout()
plt.savefig('T3(Amin).png')
# plt.show()
